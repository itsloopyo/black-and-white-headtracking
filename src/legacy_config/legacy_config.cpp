...
constexpr float kDefaultLimitX = 0.30f;
constexpr float kDefaultLimitY = 0.20f;
constexpr float kDefaultLimitZ = 0.40f;
constexpr float kDefaultLimitZBack = 0.10f;
...
ReadStatus Read(const char* path, Config& c) {
    ...
    c.pos_limit_x      = limit_or(r.ReadFloat("Position", "LimitX",     kDefaultLimitX),
                                  kDefaultLimitX);
    c.pos_limit_y      = limit_or(r.ReadFloat("Position", "LimitY",     kDefaultLimitY),
                                  kDefaultLimitY);
    c.pos_limit_z      = limit_or(r.ReadFloat("Position", "LimitZ",     kDefaultLimitZ),
                                  kDefaultLimitZ);
    c.pos_limit_z_back = limit_or(r.ReadFloat("Position", "LimitZBack", kDefaultLimitZBack),
                                  kDefaultLimitZBack);
...
std::vector<cameraunlock::config::LegacyKey> ReadKeys() {
    return {
        ...
        {"Position", "Enabled"},
        {"Position", "WorldScale"},
        {"Position", "ZoomReference"},
        {"Position", "ZoomScaleMax"},
        {"Position", "SensX"},
        {"Position", "SensY"},
        {"Position", "SensZ"},
        {"Position", "InvertX"},
